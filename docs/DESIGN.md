...
> Design notes for **fintech-phone-otp-decisions** — a runnable go example that Go service for captcha-gated phone OTP logins with payment decisions and structured audit notifications.
...
- **Feature code** — the actual task: payment login verification.
